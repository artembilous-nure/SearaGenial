...
export default function Contact() {
  ...
  const contactItems = [
    { icon: Mail, label: t.contact.labels.email, value: t.company.email, href: `mailto:${t.company.email}` },
    { icon: Phone, label: t.contact.labels.phone, value: t.company.phone, href: `tel:${t.company.phone.replace(/\s/g, '')}` },
    { icon: MapPin, label: t.contact.labels.address, value: t.company.address, href: '#' },
  ];
